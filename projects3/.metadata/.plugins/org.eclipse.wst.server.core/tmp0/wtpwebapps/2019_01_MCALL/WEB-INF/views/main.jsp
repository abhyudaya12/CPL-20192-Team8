...
<div id='wrap'>
	...
	<div id='contain'>
		...
		<div id='content_wrap'> <!-- 100%의 전체 컨텐츠 영역-->
			...
			<div class='now_bx'>
				<dl>
					<dt><!-- ><?=date('Y-m')?> --> 2019-09</dt>
					<dd>
						<ul>
							<li>
								<span>입고 <em class='current_num m5'><!-- <?=number_format($DS_GOODS_STAT['GD_IN'])?> -->0</em> </span>
								<span class='pl15'>단말기 <em class='current_num m5'><!-- <?=number_format($DS_GOODS_STAT['PHONE'])?> -->0</em></span>
			...
			<div class='content'> <!-- 원하는 컨텐츠 넓이를 추가 w960 클래스는 width:960px란 의미 -->
				...
				<div class='m_situ'>
					...
					<div class='m_02' id="div_SH_AG" style="display:block;">
						<div class="m_02_div">
							<h2>입고 <em><!-- <?=number_format($sumIn)?> -->0</em></h2>
							<table width="100%" border="0" cellspacing="0" cellpadding="0" class='m_tb'>
							<colgroup>
								<col width='50%'>
								<col width='50%'>
							...
							<tr>
								<th scope="row">단말기</th>
								<td><!-- <?=number_format($dsTopStat2['IN_PHONE_CNT'])?> -->0</td>
							</tr>
							<tr>
								<th scope="row">유심</th>
								<td><!-- <?=number_format($dsTopStat2['IN_USIM_CNT'])?> -->0</td>
							</tr>
							</table>
						</div>
	
						<div class="m_02_div">
							<h2>출고 <em><!-- <?=number_format($sumOut)?> -->0</em></h2>
							<table width="100%" border="0" cellspacing="0" cellpadding="0" class='m_tb'>
							<colgroup>
								<col width='50%'>
								<col width='50%'>
							...
							<tr>
								<th scope="row">단말기</th>
								<td><!-- <?=number_format($dsTopStat2['OUT_PHONE_CNT'])?> -->0</td>
							</tr>
							<tr>
								<th scope="row">유심</th>
								<td><!-- <?=number_format($dsTopStat2['OUT_USIM_CNT'])?> -->0</td>
							</tr>
							</table>
						</div>
					</div>
					...
					<div class='m_04' id="div_SH_SA" style="display:none;">
						<div>
							<h2>재고 <em><!-- <?=number_format($sumGoods)?> -->0</em></h2>
							<table width="100%" border="0" cellspacing="0" cellpadding="0" class='m_tb'>
							<colgroup>
								<col width='50%'>
								<col width='50%'>
							...
							<tr>
								<th scope="row">단말기</th>
								<td><!-- <?=number_format($dsTopStat2['PHONE_CNT'])?> -->0</td>
							</tr>
							<tr>
								<th scope="row">유심</th>
					...
					<!-- 개통현황 경우 -->
					<div class='m_03'>
						<h2><!-- <?=$nowMonth?> -->9월 개통현황 <em><!-- <?=$sumOpen?> -->0</em></h2>
						<table width="100%" border="0" cellspacing="0" cellpadding="0" class='m_tb'>
							<colgroup>
								<col width='50%'>
								<col width='50%'>
							...
							<tr>
								<th scope="row">신규</th>
								<td><!-- <?=number_format($dsTopStat3['OP_CNT'])?> -->0</td>
							</tr>
							<tr>
								<th scope="row">번호이동</th>
								<td><!-- <?=number_format($dsTopStat3['MV_CNT'])?> -->0</td>
							</tr>
							<tr>
								<th scope="row">재가입(기변)</th>
								<td><!-- <?=number_format($dsTopStat3['RE_CNT'])?> -->0</td>
							</tr>
						</table>
					</div>
					<!-- 개통현황 경우 -->
					...
					<div class='m_noti'>
						...
						<div class='noti_bx'>
							...
							<ul>
								...
								<li><a href="javascript:goNoticeDetail('<?=$ds['SEQ']?>');"><!-- <?=$ds['TITLE']?> -->공지2</a> <span><!-- <?=substr($ds['REG_DT'], 2, 8)?> -->2019-09-28</span></li>
								<li><a href="javascript:goNoticeDetail('<?=$ds['SEQ']?>');"><!-- <?=$ds['TITLE']?> -->공지3</a> <span><!-- <?=substr($ds['REG_DT'], 2, 8)?> -->2019-09-28</span></li>
								<li><a href="javascript:goNoticeDetail('<?=$ds['SEQ']?>');"><!-- <?=$ds['TITLE']?> -->공지4</a> <span><!-- <?=substr($ds['REG_DT'], 2, 8)?> -->2019-09-28</span></li>
								<li><a href="javascript:goNoticeDetail('<?=$ds['SEQ']?>');"><!-- <?=$ds['TITLE']?> -->공지5</a> <span><!-- <?=substr($ds['REG_DT'], 2, 8)?> -->2019-09-28</span></li>
							</ul>
