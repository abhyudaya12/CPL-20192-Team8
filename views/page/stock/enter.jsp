	...
	<div id='wrap'>
		<div id='lnb'>
			...
			%>
				...
				<li class='sel'><a href='/page/stock/enter'>입고 관리</a></li>
			...
			%>
				<li class='sel'><a href='/page/stock/stock'>재고 관리</a></li> <!-- 현재 페이지에서  메뉴 활성 -->
...
-->
					...
					<p class="num_txt mt20">
						<span class="mr10">
							<input type="button" value="입력" class="btn_t2 w90"
								onclick="javascript:enterInput();">
							<input type="button" value="유심입력" class="btn_t2 w90"
								onclick="javascript:enterUsimInput();">
	...
	<div id="pop_stock_enter_input" class="dialog-popup" style="width:900px;">
		<div id='pop'>
			<div class='title' style="border:2px solid black;">
				입고일 
				<input name="" type="text" value="2016-10-12" onclick="javascript:;" />
			...
			<div class='row_bx'>
				<p>
				<input name="" type="button" value='수기' onclick="javascript:;" />
				<input name="" type="button" value='엑셀' onclick="javascript:;" />
				<input name="" type="button" value='바코드' onclick="javascript:;" />
				</p>
				<iframe src = "enter_iframe1"></iframe>
				
				<div class='sch_reslt' id="detail_sch_result">
					<p>예정 개수 N개 (<em>1</em>)</p>
					<br>
				...
				<p style="border:2px solid black;">
					...
					<input name="detail_serial_no" id="detail_serial_no" type="text" class='w70p' />
						<select name="입고처">
							...
							<option value="4" selected>입고처</option>
						</select>
						<select name="보유처">
							<option value="1">A</option>
							<option value="2">B</option>
							<option value="3">C</option>
							<option value="4" selected>보유처</option>
						</select>
						<input name="" type="button" value='저장' class='s_button w50'
	...
	<div id="pop_stock_enter_Usiminput" class="dialog-popup" style="width:900px;">
		<div id='pop'>
			<div class='title' style="border:2px solid black;">
				입고일 
				<input name="" type="text" value="2016-10-12" onclick="javascript:;" />
				<a href="javascript:;" class='pop_close' onclick="javascript:hideDetailUPopup();">닫기</a>
			</div>
