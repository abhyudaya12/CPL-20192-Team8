...
<%@ include file="/common_inc/alert_login_inc.jsp" %>
...
<div id='wrap'>
	<div id='lnb'>
		...
		<ul class='sub'>
			...
			<li class=''><a href='/page/quick/quick'>퀵 요청하기</a></li>
			<li class=''><a href='/page/quick/stockAG'>재고 퀵 요청하기</a></li>
			<li class='sel'><a href='/page/quick/manageAG'>재고 & 퀵 관리</a></li>
			<li class=''><a href='/page/quick/record'>요청이력</a></li>
		</ul>
	</div>
