...
<div id='wrap'>
	<div id='lnb'>
		...
		<ul class='sub'>
			...
			<li class='sel'><a href='/page/calculate/calculate'>정산 내역</a></li>
			<li class=''><a href='/page/calculate/A'>정산서 관리</a></li>	
			<li class=''><a href='/page/calculate/B'>소급요청 관리</a></li>
			<li class=''><a href='/page/calculate/C'>환수 관리</a></li>
