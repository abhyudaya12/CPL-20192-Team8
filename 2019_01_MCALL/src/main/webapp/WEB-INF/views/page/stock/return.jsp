	...
	<div id='wrap'>
		<div id='lnb'>
			...
			<ul class='sub'>
				...
				<li class='sel'><a href='/page/stock/return'>반품 관리</a></li>
			</ul>
		</div>
...
-->
					...
					<p class="num_txt mt20">
						<span class="mr10">
							<input type="button" value="입력" class="btn_t2 w90"
								onclick="javascript:returnInput();">
	...
	<!-- popup -->
	<div id="pop_stock_return_input" class="dialog-popup" style="width:900px;">
		<div id='pop'>
			<div class='title' style="border:2px solid black;">
				<h2>출고일 2016 - 10 - 12 (DB)</h2>
			...
			<div class='row_bx'>
						...
						<p style="border:2px solid black;">
							...
							일련번호
							<input name="input_serial_no" id="detail_serial_no" type="text"/>
							출고가
							<input name="input_price_no" id="detail_serial_no" type="text"/>
							<input name="" type="button" value='입력' class='s_button w50'
								onclick="javascript:;" />
							</form>
						...
						<p style="border:2px solid black;">
							...
							<input name="detail_serial_no" id="detail_serial_no" type="text" class='w70p' />
								<select name="출고처">
									...
									<option value="4" selected>출고처</option>
								</select>
